 ...
 */
public class DiscCVPR implements ActionListener, ChangeListener
{
   ...
   public boolean setup(String sDefFile)
   {
      ...
      timer.reset();
      JFrame frame = new JFrame(String.format("Discover (CVPR) - %s", Library.getTitle(sDefFile)));
      gdata.frame = frame;
   ...
   public static void main(String args[])
   {
      ...
      DiscCVPR da = new DiscCVPR();
      if (!da.setup(sDefFile)){
         System.err.println("DiscCVPR setup failed.");
         System.exit(1);
      }
   }
